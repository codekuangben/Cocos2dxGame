package org.ffilmation.engine.elements
{
	...
	public class fOmniLight extends fLight
	{
		...
		public function newIntensity(e:Event):void
		{
			...
			this.color = new ColorTransform(this.lightColor.redMultiplier, this.lightColor.greenMultiplier, this.lightColor.blueMultiplier, pc, this.lightColor.redOffset, this.lightColor.greenOffset, this.lightColor.blueOffset, 0);
		}
