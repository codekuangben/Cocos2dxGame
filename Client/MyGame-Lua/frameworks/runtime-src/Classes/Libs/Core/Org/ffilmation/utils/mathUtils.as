package org.ffilmation.utils
{
	...
	public class mathUtils
	{
		...
		// 距离的平方，不开平方  
		public static function distanceSquare(x1:Number, y1:Number, x2:Number, y2:Number):Number
		{
			var dx:Number = x1 - x2;
			var dy:Number = y2 - y1;
			return (dx * dx + dy * dy);
		 ...
		 */
		public static function displacementVector(direction:Point, dist:Number):Point
		{
			...
			var scale:Number = dist / mathUtils.distance(direction.x, direction.y, 0, 0);
