package org.ffilmation.engine.renderEngines.flash9RenderEngine
{
	 ...
	 * @private
	 */
	public class fRenderMessageQueue
	{
		/** The array of messages */
		private var messages:Array;
		
		// Constructor
		public function fRenderMessageQueue():void
		{
			this.reset();
		}
		...
		public function addMessage(message:int, target:fElement, target2:fElement = null, dontStore:Boolean = false):void
		{
			...
			{
				var m:fRenderMessage = this.messages[i];
			...
			if (!dontStore)
				this.messages[this.messages.length] = new fRenderMessage(message, target, target2);
		}
