package org.ffilmation.engine.interfaces
{
	...
	public interface fEngineRenderEngine
	{
		...
		// KBEN: 
		function updateEffectPosition(effect:EffectEntity):void;
		function updateFogPosition(fog:fFogPlane):void;
		function updateFObjectPosition(fobj:fObject):void;
		...
		function set SceneLayer(value:Vector.<Sprite>):void;
