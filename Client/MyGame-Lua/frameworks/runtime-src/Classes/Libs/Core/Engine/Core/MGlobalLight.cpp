...
package org.ffilmation.engine.core
{
	...
	public class fGlobalLight extends fLight
	{
		...
		public function newIntensity(e:Event):void
		{
			...
			this.color = new ColorTransform(fLight.NOLIGHT.ra + (this.lightColor.redMultiplier - fLight.NOLIGHT.ra) * pc, fLight.NOLIGHT.ga + (this.lightColor.greenMultiplier - fLight.NOLIGHT.ga) * pc, fLight.NOLIGHT.ba + (this.lightColor.blueMultiplier - fLight.NOLIGHT.ba) * pc, 1, fLight.NOLIGHT.rb + (this.lightColor.redOffset - fLight.NOLIGHT.rb) * pc, fLight.NOLIGHT.gb + (this.lightColor.greenOffset - fLight.NOLIGHT.gb) * pc, fLight.NOLIGHT.bb + (this.lightColor.blueOffset - fLight.NOLIGHT.bb) * pc, 0);
		}
