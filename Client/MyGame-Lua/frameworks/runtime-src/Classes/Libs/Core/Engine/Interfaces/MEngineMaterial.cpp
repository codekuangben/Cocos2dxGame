#include "MEngineMaterial.h"

MEngineMaterial::MEngineMaterial()
{
...
BitmapData MEngineMaterial::getDiffuse(MRenderableElement element, float width, float height)
{
...
/**
	...
	*
	*/
DisplayObject MEngineMaterial::getBump(MRenderableElement element, float width, float height)
{
...
/**
	...
	*
	*/
Array MEngineMaterial::getHoles(MRenderableElement element, Array :Number, float height)
{
...
/**
	...
	*
	*/
Array MEngineMaterial::getContours(fRenderableElement element, float width, float height)
{
...
/**
	...
	*/
MovieClip MEngineMaterial::getHoleBlock(MRenderableElement element, float index)
{
...
/**
	...
	*/
void MEngineMaterial::dispose()
{

}
		
// KBEN:初始化资源    
void MEngineMaterial::init(SWFResource res)
{
