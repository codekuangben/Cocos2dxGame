    ...
    public class ResourceBundle
    {
        ...
        public function ResourceBundle()
        {
            ...
            for each (var v:XML in desc.variable)
            {
				...
				//m_context.m_embeddedResourceProvider[0].registerResource( resSource, resType, new res() );
				m_context.m_embeddedResourceProvider.registerResource( resSource, resType, new res() );
            }
        }                  
    }
}
