#include "TestClipNode.h"

USING_NS_CC;

bool TestClipNode::init()
{
	if (!Layer::init())
	{
		return false;
	...
	listener->onTouchesBegan = CC_CALLBACK_2(TestClipNode::onTouchesBegan, this);
	_eventDispatcher->addEventListenerWithSceneGraphPriority(listener, this);
}

void TestClipNode::onTouchesBegan(const std::vector<Touch*>& touches, Event *unused_event)
{
...
void TestClipNode::pokeHoleAtPoint(Vec2 point)
{
	CCLOG("Add a Hole!!!");
