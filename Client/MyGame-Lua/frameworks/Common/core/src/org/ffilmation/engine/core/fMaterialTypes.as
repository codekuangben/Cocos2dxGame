package org.ffilmation.engine.core
{
	...
	public class fMaterialTypes
	{
		 ...
		 *
		 * @example Here's an example of how to define a material of type fMaterialTypes.TILE
		 *
		 * <listing version="3.0">
		 ...
		 *
		 * @example Here's an example of how to define a material of type fMaterialTypes.CLIP
		 *
		 * <listing version="3.0">
		 ...
		 *
		 * @example Here's an example of how to define a material of type fMaterialTypes.PERLIN
		 *
		 * <listing version="3.0">
		 ...
		 *
		 * @example Here's an example of how to define a material of type fMaterialTypes.DOOR
		 *
		 * <listing version="3.0">
		 ...
		 *
		 * @example Here's an example of how to define a material of type fMaterialTypes.WINDOW
		 *
		 * <listing version="3.0">
		 ...
		 * @example Here's an example of how to define a material of type fMaterialTypes.FENCE
		 *
		 * <listing version="3.0">
		 ...
		 * @example Here's an example of how to define a material of type fMaterialTypes.PROCEDURAL
		 *
		 * <listing version="3.0">
