package org.ffilmation.engine.logicSolvers.collisionSolver.collisionModels
{
	...
	import org.ffilmation.engine.datatypes.fBox;
	...
	public class fBoxCollisionModel extends fBox implements fEngineCollisionModel
	{
		...
		public function testPoint(x:Number, y:Number, z:Number):Boolean
		{
			...
			var halfWidth:Number = this._width / 2;
			var halfDepth:Number = this._depth / 2;
		...
		public function testSegment(x1:Number, y1:Number, z1:Number, x2:Number, y2:Number, z2:Number):fPoint3d
		{
			...
			if (lastPoint)
			{
				...
				if (inter1)
					return new fPoint3d(lastPoint.x, lastPoint.y, inter1.y);
			}
