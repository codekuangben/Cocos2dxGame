package ui.instance
{
	...
	public class ComProgBarLoading extends PanelContainer implements IBarInProgress
	{
		...
		public var m_parForm:FormSimple;
		
		public function ComProgBarLoading(cnt:Context)
		{
			m_context = cnt;
		...
		{
			m_context.m_resMgr.load(CommonImageManager.toPathString("commoncontrol/progress/progressloading.swf"), SWFResource, onImageSwfLoaded, onImageSwfFailed);
		}
		...
		private function onImageSwfLoaded(event:ResourceEvent):void
		{
			...
			m_context.m_resMgr.unload(CommonImageManager.toPathString("commoncontrol/progress/progressloading.swf"), SWFResource);
		}
