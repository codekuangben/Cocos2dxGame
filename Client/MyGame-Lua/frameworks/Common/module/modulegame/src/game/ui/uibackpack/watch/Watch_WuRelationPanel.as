package game.ui.uibackpack.watch 
{
	 ...
	 * @author 
	 */
	public class Watch_WuRelationPanel extends WuRelationPanelBase 
	{
		protected var m_cardList:Vector.<Watch_WuCard>;
		public function Watch_WuRelationPanel(gk:GkContext, parent:DisplayObjectContainer = null, xpos:Number = 0, ypos:Number = 0)
		{
			super(gk, parent, xpos, ypos);
			m_cardList = new Vector.<Watch_WuCard>();
		}
		public function setWu(wu:WuHeroProperty):void
		{
			m_wu = wu;
			var i:int;
			var wuCard:Watch_WuCard;
			...
			for (i = 0; i < m_wu.m_vecActiveHeros.length; i++)
			{
				...
				wuCard = new Watch_WuCard(this, m_gkContext, m_cardParent, left);
