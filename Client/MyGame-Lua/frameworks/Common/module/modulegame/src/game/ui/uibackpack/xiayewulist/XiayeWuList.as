package game.ui.uibackpack.xiayewulist 
{
	...
	public class XiayeWuList extends PanelContainer implements DragListener
	{
		...
		public var m_wubtnlist:WuBtnList;
		
		public function XiayeWuList(gk:GkContext, ui:UIBackPack, parent:DisplayObjectContainer, xpos:Number = 0, ypos:Number = 0)
		{
			super(parent, xpos, ypos);
			m_gkContext = gk;
			m_ui = ui;
			
			this.setSize(180, 497);
			this.setSkinForm("form9.swf");
			this.setDropTrigger(true);
			
			m_titlePanel = new PanelContainer(this, 19, 10);
			
			m_xiayewuList = new ControlListVHeight(this, 21, 38);
			...
			m_pageTurn = new PageTurn(this, 50, 460);
		...
		public function onReadyDrop(e:DragAndDropEvent) : void
		{
			...
			if (targetCom && (targetCom == m_wubtnlist || m_wubtnlist.contains(targetCom)))
			{
