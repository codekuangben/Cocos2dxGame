package modulefight.scene.fight.rank
{
	 ...
	 * ...
	 * @author 
	 * @brief 受伤动作结束，目前仅仅是用来做一些辅助判断   
	 */
	public class RankHurtEndAction implements IRankFightAction
	{
		...
		public function RankHurtEndAction(battleArray:BattleArray)
		{
		...
		{
			return EntityCValue.RKACTHurtEnd;
		}
